...
sub _read {
    ...
    for (my $i = 0; $i < $n_entities; $i++) {
        push @{$self->{entities}}, CAD::Format::DWG::AC1_2::Entity->new($self->{_io}, $self, $self->{_root});
    }
}
...
sub _read {
    ...
    $self->{insertion_base} = CAD::Format::DWG::AC1_2::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{number_of_bytes} = $self->{_io}->read_s4le();
    $self->{number_of_entities} = $self->{_io}->read_s2le();
    $self->{drawing_first} = CAD::Format::DWG::AC1_2::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{drawing_second} = CAD::Format::DWG::AC1_2::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{limits_min} = CAD::Format::DWG::AC1_2::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{limits_max} = CAD::Format::DWG::AC1_2::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{view_ctrl} = CAD::Format::DWG::AC1_2::Point3d->new($self->{_io}, $self, $self->{_root});
...
sub _read {
    ...
    elsif ($_on == $CAD::Format::DWG::AC1_2::ENTITIES_TMP_INSERT) {
        $self->{data} = CAD::Format::DWG::AC1_2::Entity::EntityInsert->new($self->{_io}, $self, $self->{_root});
    }
    ...
    elsif ($_on == $CAD::Format::DWG::AC1_2::ENTITIES_INSERT) {
        $self->{data} = CAD::Format::DWG::AC1_2::Entity::EntityInsert->new($self->{_io}, $self, $self->{_root});
    }
...
########################################################################
package CAD::Format::DWG::AC1_2::Entity::EntityInsert;
